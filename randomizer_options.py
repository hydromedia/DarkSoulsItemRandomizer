...
class RandomizerOptions:
    def __init__(self, difficulty, fashion_souls, key_placement, 
     ...
     game_version, randomize_npc_armor, pirate_weapons, ninja_weapons):
         ...
         self.pirate_weapons = pirate_weapons
         self.ninja_weapons = ninja_weapons
    ...
    def as_string(self):
        ...
        return_string += "  Pirate Weapons: " + self.bool_option_to_string(self.pirate_weapons) + "\n"
        return_string += "  Ninja Weapons: " + self.bool_option_to_string(self.ninja_weapons) + "\n"
